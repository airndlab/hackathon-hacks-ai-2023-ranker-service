...
tokenizer = AutoTokenizer.from_pretrained("./model/tokenizer_sbert_large_nlu_ru") # "ai-forever/sbert_large_nlu_ru"
model = AutoModel.from_pretrained("./model/model_sbert_large_nlu_ru/") # "ai-forever/sbert_large_nlu_ru"
